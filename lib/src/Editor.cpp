	...
	, commandQueue(commandQueue)
{
	...
	stateMgr.addState(std::to_string(ToolType::Mesh), new ToolMesh(gui, onStateChanged, commandQueue));
	stateMgr.addState(std::to_string(ToolType::Item), new ToolItem(gui, onStateChanged, commandQueue));
	stateMgr.addState(std::to_string(ToolType::Trigger), new ToolTrigger(gui, onStateChanged, commandQueue));
